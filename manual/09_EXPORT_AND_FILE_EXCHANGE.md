...
ACE Studio exchange is planned as a file and workflow integration.

DAWHermes does not currently send tracks directly to ACE Studio or receive processed results automatically.

Do not expect an ACE-specific menu command until that milestone is implemented and documented.
...
- There is no ACE Studio exchange yet.
